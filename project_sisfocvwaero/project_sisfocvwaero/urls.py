...
urlpatterns = [
    ...
    path("home/absensi_masuk/face_detection", face_detection, name="face_detection"),
    path("home/absensi_masuk/face_detection_index", face_detection_index, name="face_detection_index"),
    path("home/absensi_masuk/absensi", absensi, name="absensi"),
    ...
    path("home/absensi_masuk/capture", capture, name="capture"),
